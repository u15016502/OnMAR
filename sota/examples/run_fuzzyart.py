"""
Example script for running Auto-sklearn with Fuzzy ART Generation Application.

This demonstrates how to use Auto-sklearn to replace GE for generating
...
def run_autosklearn_fuzzyart_example(
    dataset_name: str = 'enron',
    time_budget: int = 3600,
    max_evaluations: int = 40
):
    """
    Run Auto-sklearn with Fuzzy ART generation application.
    ...
    """
    print(f"\n{'='*60}")
    print(f"Running Auto-sklearn with Fuzzy ART Generation")
    ...
    print(f"\nBest Choice Function Parameters:")
...
if __name__ == "__main__":
    # Example: Run Auto-sklearn on Enron
    results = run_autosklearn_fuzzyart_example(
        dataset_name='enron',
        time_budget=1800,  # 30 minutes
        max_evaluations=25  # Reduced for quick testing
    )
